...
let numeroJog1 = 0;
let numeroJog2 = 0;
const introducao = prompt(
  "JOGO DA VELHA \n==================== \nPressione [ENTER] para começar..."
);
jogo0: while (true) {
  console.log();
  let opcoesDeJogo = +prompt(
    "Escolha um modo de jogo [1]Jogador/Máquina [2]Jogador/Jogador: "
  );
  ...
  if (opcoesDeJogo == 1) {
    ...
    console.log();
    XouOJog1 = +prompt(
      "Jogador(1), Escolha seu símbolo para jogar [1]X [2]O: "
    );
    while (XouOJog1 != 1 && XouOJog1 != 2) {
      console.log("\nDigite apenas [1] ou [2]!");
      XouOJog1 = +prompt("Escolha seu símbolo para jogar [1]X [2]O: ");
    }
    if (XouOJog1 == 1) {
      console.log(`\nJogador(1): X \nJogador(2): O`);
    } else {
    ...
    jogo2: while (true) {
      ...
      if (opcoesDeJogo == 1) {
        jogador: while (true) {
          ...
          if (checarEspacos(numero, letra) == true) {
            break;
          }
        ...
        console.log(
          `O computador jogou ${computadorLetra1}${computadorNumero}`
        );
        ...
        jogador1: while (true) {
          ...
          while (
            ...
            console.log("Resposta inválida, escolha a letra [A], [B] ou [C]!");
            letraJog1 = prompt(
              "Jogador(1), escolha uma letra [A], [B] OU [C]: "
            );
          }
          numeroJog1 = +prompt(
            "Jogador(1), escolha um número [1], [2], [3]:  "
          );
        ...
        jogador2: while (true) {
          ...
          while (
            ...
            console.log("Resposta inválida, escolha a letra [A], [B] ou [C]!");
            letraJog2 = prompt(
              "Jogador(2), escolha uma letra [A], [B] OU [C]: "
            );
          }
          numeroJog2 = +prompt(
            "Jogador(2), escolha um número [1], [2], [3]:  "
          );
  ...
  console.log();
  let novoJogo = +prompt(
    "O jogo acabou, gostaria de jogar de novo [1]SIM ou [2]NÃO? "
  );
