...
jogo: while (true) {
  aventura: while (true) {
    ...
    const statusJogador = {
      ...
      consultarInventário: function () {
        console.log(`Mapa: ${this.mapa}`);
        console.log(`Espada: ${this.espada}`);
        console.log(`Capa contra fogo: ${this.capa}`);
        console.log(`Amuleto mágico: ${this.amuleto}`);
        prompt(`[ENTER]`);
      },
      ...
      regeneracao: function (quantidade) {
        this.vida += quantidade;
        if (this.vida > 100) {
          console.log(`\nSua vida está cheia.\n`);
          this.vida = 100;
        } else {
          console.log(`\nSua vida aumentou +${quantidade}.\n`);
        }
        prompt(`[ENTER]`);
      },
      gastarDinheiro: function (quantidade) {
      ...
      ganharDinheiro: function (quantidade) {
        console.log(`\n+${quantidade} de dinheiro.\n`);
        this.dinheiro += quantidade;
        prompt(`[ENTER]`);
      },
      ...
      diminuirAtaque: function (quantidade) {
        console.log(`\nSeu ataque diminuiu em -${quantidade}.\n`);
        this.ataque -= quantidade;
        if (this.ataque < 0) {
          console.log(`\nSeu ataque chegou em 0.\n`);
          this.ataque = 0;
        }
        prompt(`[ENTER]`);
      },
      ...
      diminuirDefesa: function (quantidade) {
        console.log(`\nSua defesa diminuiu em -${quantidade}.\n`);
        this.defesa -= quantidade;
        if (this.defesa < 0) {
          console.log(`\nSua defesa chegou em 0.\n`);
          this.defesa = 0;
        }
        prompt(`[ENTER]`);
      },
      ...
      diminuirMagia: function (quantidade) {
        console.log(`\nSua magia diminuiu em +${quantidade}.\n`);
        this.magia -= quantidade;
        if (this.magia < 0) {
          console.log(`\nSua magia chegou em 0.\n`);
          this.magia = 0;
        }
        prompt(`[ENTER]`);
      },
      ...
      diminuirGrupo: function (quantidade = 1) {
        this.grupo -= quantidade;
        console.log(`\nSeu grupo diminuiu em -${quantidade} membro. \nQuantidade atual: ${this.grupo} membros.\n`);
        prompt(`[ENTER]`);
      },
      ...
      diminuirTempo: function (quantidade = 1) {
        this.tempo -= quantidade;
      },
      insultar: function () {
        let insultos = [
      ...
      opcoesDeJogada: function (a) {
        ...
        if (opcao == 1) {
          ...
          while (numeroAleatorio < this.ataque * 0.45) {
    ...
    const jhonny = {
      ...
      regeneracao: function (quantidade) {
        this.vida += quantidade;
        if (this.vida > 100) {
          console.log(`\nA vida de Jhonny está cheia.\n`);
          this.vida = 100;
        } else {
          console.log(`\nJhonny ganhou +${quantidade} de vida.\n`);
        }
        prompt(`[ENTER]`);
      },
      gastarDinheiro: function (quantidade) {
        this.dinheiro -= quantidade;
        if (this.dinheiro < 0) {
          console.log(`\nO dinheiro de Jhonny acabou.\n`);
          this.dinheiro = 0;
        } else {
          console.log(`\nJhonny perdeu -${quantidade} de dinheiro.\n`);
        }
        prompt(`[ENTER]`);
      },
      ganharDinheiro: function (quantidade) {
        console.log(`\nJhonny ganhou +${quantidade} de dinheiro.\n`);
        this.dinheiro += quantidade;
        prompt(`[ENTER]`);
      },
      aumentarAtaque: function (quantidade) {
      ...
      diminuirAtaque: function (quantidade) {
        console.log(`\nO ataque de Jhonny diminuiu em -${quantidade}.\n`);
        this.ataque -= quantidade;
        if (this.ataque < 0) {
          console.log(`\nO ataque de Jhonny chegou em 0.\n`);
          this.ataque = 0;
        }
        prompt(`[ENTER]`);
      },
      ...
      diminuirDefesa: function (quantidade) {
        console.log(`\nA defesa de Jhonny diminuiu em -${quantidade}.\n`);
        this.defesa -= quantidade;
        if (this.defesa < 0) {
          console.log(`\nA defesa de Jhonny chegou em 0.\n`);
          this.defesa = 0;
        }
        prompt(`[ENTER]`);
      },
      jogada: function () {
        let numeroAleatorio = Math.floor(Math.random() * this.ataque + 1);
        while (numeroAleatorio < this.ataque * 0.3) {
          numeroAleatorio = Math.floor(Math.random() * this.ataque + 1);
        }
    ...
    const amanda = {
      ...
      regeneracao: function (quantidade) {
        this.vida += quantidade;
        if (this.vida > 100) {
          console.log(`\nA vida de Amanda está cheia.\n`);
          this.vida = 100;
        } else {
          console.log(`\Amanda ganhou +${quantidade} de vida.\n`);
        }
        prompt(`[ENTER]`);
      },
      gastarDinheiro: function (quantidade) {
        ...
        if (this.dinheiro < 0) {
          ...
          console.log(`\Amanda perdeu -${quantidade} de dinheiro.\n`);
        }
        prompt(`[ENTER]`);
      },
      ganharDinheiro: function (quantidade) {
        console.log(`\Amanda ganhou +${quantidade} de dinheiro.\n`);
        this.dinheiro += quantidade;
        prompt(`[ENTER]`);
      },
      aumentarAtaque: function (quantidade) {
      ...
      diminuirAtaque: function (quantidade) {
        console.log(`\nO ataque de Amanda diminuiu em -${quantidade}.\n`);
        this.ataque -= quantidade;
        if (this.ataque < 0) {
          console.log(`\nO ataque de Amanda chegou em 0.\n`);
          this.ataque = 0;
        }
        prompt(`[ENTER]`);
      },
      ...
      diminuirDefesa: function (quantidade) {
        console.log(`\nA defesa de Amanda diminuiu em -${quantidade}.\n`);
        this.defesa -= quantidade;
        if (this.defesa < 0) {
          console.log(`\nA defesa de Amanda chegou em 0.\n`);
          this.defesa = 0;
        }
        prompt(`[ENTER]`);
      },
    ...
    const dragao = {
      nome: "Dragão",
      nivel: 4,
      descricao: "Ser elegante que via e gospe fogo.",
      vida: 100 * statusJogador.nivel,
      ataque: 20 * statusJogador.nivel,
      defesa: 10 * statusJogador.nivel,
      dinheiro: 0,
    ...
    const modosdDeJogo = [
      ...
      "[1]MODO HISTÓRIA - Entre em uma aventura épica",
      "[2]MODO SOBREVIVÊNCIA - Batalhe até se cansar",
    ];
    ...
    dia1: while (escolhaModo == 1) {
      ...
      prompt(
        `\nAo entrar em sua cidade, um guarda real vêm ao seu encontro e diz: \n'${statusJogador.nome}, nosso rei precisa de sua presença o mais rápido possível!' [ENTER]`
      );
      console.clear();
      prompt(
      ...
      if (personagem == 1) {
        prompt(
          `\n'${statusJogador.nome}, você já fez parte de minha guarda real, é o único guerreiro que pode deter Mordog!'[ENTER]`
        );
      } else {
        prompt(
          `\n'${statusJogador.nome}, você já fez parte de minha guarda real, é a única guerreira que pode deter Mordog!'[ENTER]`
        );
      }
      console.clear();
      console.log(
      ...
      if (b == 1) {
        ...
        statusJogador.aumentarAtaque(20);
        statusJogador.pontuacao += 1;
      ...
      console.log();
      prompt(
        "Após arrumar todas as coisas, visita seu vizinho elfo, que entende um pouco de magia e abençoa seu caminho. [ENTER]"
      );
      console.log(
      ...
      if (d == 1) {
        ...
        statusJogador.aumentarMagia(50);
        statusJogador.pontuacao += 1;
    ...
    dia2: while (escolhaModo == 1) {
      ...
      if (escolha1 == 1) {
        ...
        prompt(
          "'Mordog é extremamente poderoso, mesmo que consiga chegar até ele, é impossível derrotá-lo com todas as almas que ele já possui.' [ENTER]"
        );
        if (statusJogador.grupo >= 1) {
          console.log(
    ...
    dia3: while (escolhaModo == 1) {
      ...
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          prompt(
            "Após terem derrotado o Goblin, você e Jhonny encontram-se passando pelo meio de uma floresta muito densa.[ENTER]"
          );
          if (kills == 0) {
          ...
          prompt(
            "Após ter derrotado o Goblin, você encontra-se passando pelo meio de uma floresta muito densa.[ENTER]"
          );
          if (kills == 0) {
            console.log(
        ...
        if (statusJogador.grupo >= 1) {
          prompt(
            "Após terem derrotado o Goblin, você e Amanda encontram-se passando pelo meio de uma floresta muito densa.[ENTER]"
          );
          if (kills == 0) {
            console.log("\n'Você ouviu o que o Goblin falou? temos que nos apressar se quisermos derrotar o inimigo.'");
      ...
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          prompt(
            "Ao longe vocês avistam um elfo em cima de uma árvore. Ele é magro e está com uma linda roupa feita de folhas e cordas biodegradáveis. [ENTER]"
          );
          ...
          prompt(
            "Ao longe você avista um elfo em cima de uma árvore. Ele é magro e está com uma linda roupa feita de folhas e cordas biodegradáveis. [ENTER]"
          );
      ...
      backup(2, statusJogador);
      console.clear();
      console.log("'Você é mais forte do que eu pensava. É digno da vitória!'\n");
      ...
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          if (escolha2 == 1) {
            ...
            console.clear();
            console.log(
              "'Sabe, a várias gerações atrás Mordog já foi diferente. Ele foi um rei bruxo que usava seus poderes para praticar o bem.'"
            );
    ...
    dia4: while (escolhaModo == 1) {
      ...
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          ...
          prompt(
            "Foi então quando um barulho de passos os assustou, passos que faziam tremer o chão abaixo de vocês. [ENTER]"
          );
          console.log("\nO ser gigante lhes pergunta: ");
          console.log(
            "'Fiquei sabendo que dois humanos estão passando aqui perto. Eu vim acabar com eles antes que cheguem no meu mestre.'"
          );
          ...
          prompt(
            "Você dormia. Foi então quando um barulho de passos o acordou, passos que faziam tremer o chão abaixo de você. [ENTER]"
          );
          console.log("\nO ser gigante lhe pergunta: ");
          console.log(
            "'Fiquei sabendo que um humano está passando aqui perto. Eu vim acabar com ele antes que chegue no meu mestre.'"
          );
        ...
        if (statusJogador.grupo >= 1) {
          ...
          prompt(
            "Foi então quando um barulho de passos as assustou, passos que faziam tremer o chão abaixo de vocês. [ENTER]"
          );
          console.log("\nO ser gigante lhes pergunta: ");
          console.log(
            "'Fiquei sabendo que duas humanas estão passando aqui perto. Eu vim acabar com elas antes que cheguem no meu mestre.'"
          );
          ...
          prompt(
            "Você dormia. Foi então quando um barulho de passos a acordou, passos que faziam tremer o chão abaixo de você. [ENTER]"
          );
          console.log("\nO ser gigante lhe pergunta: ");
          console.log(
            "'Fiquei sabendo que uma humana está passando aqui perto. Eu vim acabar com ela antes que chegue no meu mestre.'"
          );
    ...
    dia5: while (escolhaModo == 1) {
      ...
      if (escolha4 == 1) {
        ...
        console.log("\n'Mas certo dia seu seu reino foi atacado por bandidos saqueadores.'");
    ...
    dia6: while (escolhaModo == 1) {
      ...
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          ...
          console.log();
          console.log(
            "'O Dragão que enfrentamos ontem era muito poderoso, e ele ainda avisou que será mais difícil à frente.'"
          );
          prompt("Disse Jhonny. [ENTER]");
          console.log();
          ...
          console.log();
          console.log(
            "'O Dragão que enfrentamei ontem era muito poderoso, e ele ainda avisou que será mais difícil à frente.'"
          );
          prompt("Você pensa. [ENTER]");
          console.log();
    ...
    dia7: while (escolhaModo == 1) {
      ...
      console.clear();
      statusJogador.aumentarTempo();
      console.log("================ \nUMA REVALAÇÃO INESPERADA");
      console.log();
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          if (statusJogador.mapa >= 1) {
            console.log(
              "Após desarmarem o acampamento e continuarem seguindo o mapa, vocês avistam a montanha onde possivelmente está a caverna do bruxo."
            );
            prompt("[ENTER]");
          } else {
            console.log(
              "Após desarmarem o acampamento e continuarem a jornada, vocês avistam a montanha onde possivelmente está a caverna do bruxo."
            );
            prompt("[ENTER]");
          }
          console.log("\nJhonny fala:");
          ...
          if (statusJogador.mapa >= 1) {
            console.log(
              "Após desarmar o acampamento e continuar seguindo o mapa, você avista a montanha onde possivelmente está a caverna do bruxo."
            );
            prompt("[ENTER]");
          } else {
            console.log(
              "Após desarmar o acampamento e continuar a jornada, você avista a montanha onde possivelmente está a caverna do bruxo."
            );
            prompt("[ENTER]");
          }
        ...
        if (statusJogador.grupo >= 1) {
          ...
          if (statusJogador.mapa >= 1) {
            console.log(
              "Após desarmar o acampamento e continuarem seguindo o mapa, você avista a montanha onde possivelmente está a caverna do bruxo."
            );
            prompt("[ENTER]");
          } else {
            console.log(
    ...
    dia8: while (escolhaModo == 1) {
      ...
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          console.log(
            "Após desmontarem o acampamento, vocês estão agora a poucos quilômetros de distância da montanha.\n"
          );
          prompt("[ENTER]");
      ...
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          ...
          prompt("Lágrimas saem dos olhos do bruxo. [ENTER]");
          console.log("\n'E pretendo velos de novo'.");
          prompt("'Mesmo depois da derrota, você não vão conseguir me impedir' [ENTER]");
        }
      } else if (personagem == 2) {
        if (statusJogador.grupo >= 1) {
          prompt("'Vocês conseguiram mesmo me derrotar, foi uma batalha digna.' [ENTER]");
      ...
      if (statusJogador.pocao >= 1) {
        ...
        if (final == 1) {
          ...
          prompt(
            "Mordog realiza seu desejo de ver sua família, mas acaba não resistindo ao seu próprio feitiço. [ENTER]"
          );
        }
      } else
        prompt(
          "Mordog consegue realizar seu desejo de ver sua família, mas acaba não resistindo ao seu próprio feitiço. [ENTER]"
        );
      if (personagem == 1) {
        if (statusJogador.grupo >= 1) {
          console.log(
      ...
      if (selecaoDeOponente == 0) {
        ...
        while (true) {
          ...
          if (statusJogador.vida <= 0) {
            console.log("\nVOCÊ MORREU.");
            backup(2, statusJogador);
            let z = +prompt("\nGostaria de reniciar o Modo Sobrevivência? [1]SIM [2]NÃO: ");
            while (z != 1 && z != 2) {
              console.log("\nNÚMERO INVÁLIDO!");
              z = +prompt("\nGostaria de reniciar o Modo Sobrevivência? [1]SIM [2]NÃO: ");
            }
