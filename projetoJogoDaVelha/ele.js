...
const status = {
  ...
  testarFome: function () {
    ...
    if (this.fome >= 5) {
      if (this.horas < 12) {
        ...
        while (escolhaFomeCafe != 1 && escolhaFomeCafe != 2 && escolhaFomeCafe != 3) {
          console.log("Digite uma opção válida!");
        ...
        if (this.testarDinheiro() == true) {
          if (escolhaFomeCafe == 1) {
            ...
            console.log("Come um gorduroso e nada saudável, hambúrger!");
            this.fome -= 2;
            this.saude--;
            this.dinheiro--;
        ...
        while (escolhaFomeAlmoco != 1 && escolhaFomeAlmoco != 2 && escolhaFomeAlmoco != 3) {
          console.log("Digite uma opção válida!");
        ...
        if (this.testarDinheiro() == true) {
          if (escolhaFomeAlmoco == 1) {
            console.log("Come uma pratada de arroz, feijão e carne!");
            this.fome -= 3;
            this.dinheiro -= 1;
            this.aumentarHorario30();
        ...
        while (escolhaFomeTarde != 1 && escolhaFomeTarde != 2 && escolhaFomeTarde != 3) {
          console.log("Digite uma opção válida!");
  ...
  testarHigiene: function () {
    ...
    if (this.higiene <= 5) {
      ...
      while (escolhaHigiene != 1 && escolhaHigiene != 2 && escolhaHigiene != 3) {
        console.log("Digite uma opção válida!");
...
if (personagem.verificarIdade() == "menor") {
  ...
  console.log(`${personagem.idade} anos! Você já é um adulto. Aproveite bem o seu tempo.`);
  personagem.idadeStatus = personagem.verificarIdade();
} else {
  console.log(
...
while (status.dia < dias) {
  ...
  console.log("Você tem que estar no trabalho as 9h. Por isso costumar sair no maximo as 8h de casa para dar tempo.");
  ...
  if (status.horas == 9 && status.minutos == 0) {
    ...
    console.log(`Muito bem, ${status.nome}. Você chegou no horário certinho!`);
  } else if (status.horas >= 9 && status.minutos >= 0) {
    console.log("Você chega no trabalho e já dá de cara com seu chefe!");
    console.log(`${status.nome}, você esta atrasado e sabe que vai ser descontado do seu salário no final do dia né?`);
    horaExtra--;
  } else {
    console.log("Você chega no trabalho e já dá de cara com seu chefe!");
    console.log(`Muito bem, ${status.nome}. Você esta adiantado. Irei te pagar um extra no final do dia!`);
    horaExtra++;
  }
  enter = prompt("Pressione ENTER.");
  status.exibirStatus();

  console.log("Entao você fica fazendo o seu serviço como um bom funcionario!");
